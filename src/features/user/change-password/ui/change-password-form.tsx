...
export const ChangePasswordForm = reatomComponent(({ deleteUser }: ChangePasswordFormProps) => {
    ...
    <Form onSubmit={submit}>
      ...
      <FormField field={fields.passwordConfirmation}>
        <FormItem>
          ...
          <FormControl>
            <Input type="password" autoComplete="new-password" {...passwordConfirmationField} />
          </FormControl>
          <FormMessage />
        </FormItem>
      </FormField>
