...
const editorRowClassName = cn("grid min-h-0 min-w-[40vw] flex-1 grid-cols-2 grid-rows-1 gap-3");
...
export const QuestionFields = reatomComponent(({ question, answer }: QuestionFieldsProps) => {
